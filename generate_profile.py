...
INFO = [
    ...
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Java (primary) · Python · SQL", "val"),
    ("Backend",  "Spring Boot · Spring Security · JPA · OAuth2", "val"),
    ("Data",     "PostgreSQL · MySQL · Redis", "val"),
    ("Tools",    "Docker · GitHub Actions · Git · Maven", "val"),
    ("Concepts", "DSA · High-Level Design · OS · OOP", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("EventRelay", "Distributed Webhook Delivery Platform", "warn"),
    ("",         "20K+ events/sec, <12ms P99 latency, SQS", "muted"),
    ("VectorLink", "URL Shortener & Event-Driven Pipeline", "warn"),
    ("",         "Kafka, Redis write-through cache, OAuth2", "muted"),
    ("ArchSim",  "Distributed Systems Simulation Canvas", "warn"),
    ("",         "React/WebSockets CRDT, TimescaleDB, SDE", "muted"),
    ("__blank__", "", ""),
    ("__section__", "~/achievements", ""),
    ("Hackspire", "Finalist · HackspireX '26 Hackathon", "val"),
    ("Forge",    "Finalist · ForgeAscend '26 Build-a-thon", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("In",       "linkedin.com/in/sathwik-chappala", "accent"),
    ("GitHub",   "github.com/sathwik7993", "accent"),
    ("LeetCode", "leetcode.com/u/sathwikch228", "accent"),
    ("Mail",     "chappalasathwik@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Backend SDE / Distributed Systems roles</tspan>'
